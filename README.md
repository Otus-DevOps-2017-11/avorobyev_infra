...
```
- Редактируя плейбук molecule в который раз смутила необходимость принудительной вставки become: true в контекст вызова роли. Получаем недостаточную абстакцию/инкапсуляцию: - при вызове приходится помнить о специфике некоторых задач роли.  Почему бы сразу не определять этот флаг в задачах, требующих повышения привелегий?
